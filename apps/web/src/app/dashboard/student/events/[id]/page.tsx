      ...
      try {
        ...
        if (!registrationsResponse.ok) {
          if (registrationsResponse.status === 404) {
            // If no registrations found, that's okay - user hasn't registered for any events
  ...
  if (error || !event) {
    return <div className="min-h-screen bg-gradient-to-r from-[#7a8c9e] to-[#a8a4c5] p-8">
      <div className="text-center text-white">
        ...
        <Link href="/dashboard/student/events" className="text-purple-300 hover:text-purple-100">
          ← Back to Events
        </Link>
      </div>
    </div>;
    ...
    <div className="min-h-screen bg-gradient-to-r from-[#7a8c9e] to-[#a8a4c5] p-8">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          />
          <Link href="/dashboard/student/events" className="text-purple-300 hover:text-purple-100 mb-4 inline-block">
            ← Back to Events
          </Link>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="space-y-2 text-white/80">
                  <p>👤 Organizer: {event.createdBy?.name || 'Unknown'}</p>
                  <p>📧 Email: {event.createdBy?.email || 'Not available'}</p>
                </div>
              </div>
            </div>
