...
export default function ClubDashboardLayout({
  ...
  const navItems = [
    { name: 'Feed', path: '/dashboard/club/feed' },
    { name: 'Manage Events', path: '/dashboard/club/manage' },
    { name: 'Stats', path: '/dashboard/club/stats' },
    { name: 'Profile', path: '/dashboard/club/profile' },
  ];
